...
export function Hero({ manifestoContent }: HeroProps) {
    return (
        <section className="relative min-h-[95vh] flex items-center justify-center overflow-hidden bg-background selection:bg-primary selection:text-white">
            ...
            <div className="absolute inset-0 z-0">
                ...
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-surface/10 via-background to-background"></div>
            ...
            <div className="container relative z-20 px-4 text-center">
                ...
                >
                    ...
                    <h1 className="flex flex-col items-center justify-center md:gap-2 mb-8">
                        <span className="text-6xl md:text-8xl lg:text-9xl font-black text-transparent bg-clip-text bg-gradient-to-b from-white to-muted tracking-tighter leading-[0.9]">
                            {siteConfig.hero.title}
                        </span>
                        <span className="text-4xl md:text-6xl lg:text-7xl font-bold text-primary tracking-tighter">
                    ...
                    <div className="max-w-3xl mx-auto mb-12 relative">
                        <div className="absolute -left-4 top-0 bottom-0 w-1 bg-gradient-to-b from-primary to-transparent opacity-50 hidden md:block" />
                        <p className="text-lg md:text-2xl text-muted font-light leading-relaxed pl-0 md:pl-6 text-balance">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 items-center w-full justify-center">
                        ...
                        <Link
                            ...
                            className="group relative px-8 py-4 border border-primary text-primary text-lg font-bold tracking-tight overflow-hidden rounded-sm hover:scale-[1.02] transition-transform duration-200"
                        >
                        ...
                        <Link
                            ...
                            className="px-8 py-4 text-muted hover:text-foreground font-medium border-b border-transparent hover:border-primary transition-colors flex items-center gap-2 group"
                        >
            ...
            >
                <span className="text-[10px] uppercase tracking-[0.3em] text-muted">Descubre la verdad</span>
